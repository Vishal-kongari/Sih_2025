      ...
      <main className="container py-8 grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="md:col-span-2 border-0 shadow-large bg-card/70 backdrop-blur">
          ...
          <CardContent className="space-y-3">
            <div className="p-4 rounded-xl border">10:00 AM • Emma Thompson • Individual</div>
            <div className="p-4 rounded-xl border">11:30 AM • James Wilson • Follow-up</div>
            <div className="p-4 rounded-xl border">2:00 PM • Sarah Davis • Initial</div>
          </CardContent>
        </Card>
